...
contract Treasury is Ownable, ILayerZeroTreasury {
    ...
    function getFee(address, /*_sender*/ uint32, /*_eid*/ uint256 _totalFee, bool _payInLzToken)
        external
        view
        override
        returns (uint256)
    ...
    function payFee(address, /*_sender*/ uint32, /*_eid*/ uint256 _totalFee, bool _payInLzToken)
        external
        payable
        override
        returns (uint256)
