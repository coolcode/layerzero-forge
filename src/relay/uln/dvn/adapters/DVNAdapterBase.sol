...
import { ISendLib } from "src/protocol/interfaces/ISendLib.sol";
...
abstract contract DVNAdapterBase is Ownable, ILayerZeroDVN {
    ...
    function _encodePayload(bytes memory _packetHeader, bytes32 _payloadHash)
        internal
        pure
    ...
    function _decodePayload(bytes memory _payload)
        internal
        pure
        returns (bytes memory packetHeader, bytes32 payloadHash)
    {
